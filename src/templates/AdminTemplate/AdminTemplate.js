...
const AdminTemplate = () => {
  ...
  useEffect(() => {
    ...
    quanLyNguoiDungServ
      .thongTinTaiKhoanLocal(userLocal)
      .then((result) => {
        // console.log(result.data.taiKhoan);
        setNameLocal(result.data.taiKhoan);
  ...
  return (
    ...
    >
      ...
      <Layout>
        ...
        >
          <div
            className="btn-conteiner h-1/2 mt-4"
            onClick={() => {
              navigate("/");
            }}
          >
          ...
          <div className="flex items-center gap-2">
            <span className="font-bold">Chào {nameLocal}</span>
            <img
              className="w-14 h-14 rounded-[50%] object-cover z-10 "
            ...
            <Link to={"/"}>
              <i
                ...
                className="fas fa-power-off text-[#f6ba35] text-xl"
              ></i>
            </Link>
          </div>
        </Header>
