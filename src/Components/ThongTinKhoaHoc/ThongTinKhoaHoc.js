...
import "./thongTinKhoaHoc.scss";

const ThongTinKhoaHoc = () => {
  return (
    <div className="khoaHoc">
      <div className="thongTinKhoaHoc">
        <div className="itemKhoaHoc itemLon">
          <div className="noiDungKhoaHoc">
            <h3>Khóa học</h3>
            <p>
        ...
        <div className="itemKhoaHoc itemNhoA">
          <div className="noiDungKhoaHoc">
        ...
        <div className="itemKhoaHoc itemNhoB">
          <div className="noiDungKhoaHoc">
        ...
        <div className="itemKhoaHoc itemNhoC">
          <div className="noiDungKhoaHoc">
            <h3>Chứng nhận</h3>
            <ul>
              <li>
